/**
 * This creates and maintains the game of Tic Tac Toe. Note that if this were following better practice, I would be using a Controller that would make communication
 * between the GUI and the Logic possible. Typically you would not want to have a reference to your interface in your Logic class.
 * 
...
public class TicTacToeLogic
{
    ...
    private void gameLoop()
    {
        ...
        do
        {
            ...
            //Keep running through the same game while there have not been 9 moves, and while the game has not been won by either player
    ...
    {   
        //This gets the state of the gameboard from the GUI. This will be used as the initial node in the search.
